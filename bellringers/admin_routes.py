...
def create_admin_blueprint():
    ...
    def require_admin():
        ...
        if not session.get('admin_logged_in'):
            return redirect(url_for('bellringers.admin.login'))
        return None
            ...
            if username and password:
                ...
                if db.verify_admin(username, password_hash):
                    ...
                    if request.is_json:
                        ...
                        return redirect(url_for('bellringers.admin.dashboard'))

            if request.is_json:
                return jsonify({'error': 'Invalid credentials'}), 401
            else:
                return render_template('bellringers/admin/login.html', error='Invalid credentials')

        return render_template('bellringers/admin/login.html')
    ...
    def dashboard():
        ...
        return render_template('bellringers/admin/dashboard.html',
                             summary=summary,
    ...
    def content():
        ...
        return render_template('bellringers/admin/content.html',
                             pending=pending,
